 ...
 */
cloudflareStream.media.view.MediaFrame = Post.extend( /** @lends @lends cloudflareStream.media.view.MediaFrame.prototype */{
	...
	updateAttachment: function( event ) {
		...
		jQuery.ajax( {
			url: 'https://api.cloudflare.com/client/v4/accounts/' + cloudflareStream.api.account + '/media/' + attachment.uid,
			method: 'POST',
